...
/** Distinct physical archetypes for the transmission objects on the altar.
 *  Passages use the six manuscript-form archetypes; vessels use the six sound
 *  -or-substance archetypes. The form itself carries half the resonance signal. */
export type ObjectArchetype =
  | "leather-book" | "stone-tablet" | "open-codex"
  | "book-on-side" | "scroll" | "lectern"
  | "abalone-shell" | "brass-bowl" | "tuning-fork"
  | "glass-vial" | "bone-flute" | "bronze-bell";

export type MistColor = "rose" | "blue" | "gold" | "violet";

type OfferingBase = {
  id: string;
  kind: OfferingKind;
  glyph: string;        // short token retained for legacy & alt-text
  title: string;        // hidden until reception
  themes: string[];     // resonance keywords
  domain?: DomainId;    // soft domain affinity
  placeholder: true;
  /** Visual archetype rendered on the altar in lieu of a card primitive. */
...
export type Vessel = OfferingBase & {
  ...
  /** When archetype is "glass-vial", tints the mist overlay. */
  mistColor?: MistColor;
};
...
// Archetype cycles through the six passage forms, biased by domain.

export const PASSAGES: Passage[] = [
  ...CANONICAL_SIX,
  {
    id: "ps-broken-vow", kind: "passage", glyph: "I", title: "On the Broken Vow",
    domain: "spirit", themes: ["vow", "promise", "fracture", "world"], placeholder: true,
    objectArchetype: "open-codex",
  ...
  {
    id: "ps-bars-unseen", kind: "passage", glyph: "II", title: "Of the Bars One Cannot See",
    domain: "mind", themes: ["cage", "bars", "freedom", "perception"], placeholder: true,
    objectArchetype: "stone-tablet",
  ...
  {
    id: "ps-architect-waking", kind: "passage", glyph: "III", title: "The Architect Awakens",
    domain: "craft", themes: ["architect", "building", "agency", "design"], placeholder: true,
    objectArchetype: "scroll",
  ...
  {
    id: "ps-sovereign-field", kind: "passage", glyph: "IV", title: "On the Sovereign Field",
    domain: "voice", themes: ["sovereign", "field", "boundary", "authority"], placeholder: true,
    objectArchetype: "leather-book",
  ...
  {
    id: "ps-inheritance", kind: "passage", glyph: "V", title: "Of the Inheritance",
    domain: "lineage", themes: ["inheritance", "lineage", "carried", "given"], placeholder: true,
    objectArchetype: "lectern",
  ...
  {
    id: "ps-mirror", kind: "passage", glyph: "VI", title: "The Mirror",
    domain: "mind", themes: ["mirror", "face", "reflection", "self"], placeholder: true,
    objectArchetype: "stone-tablet",
  ...
  {
    id: "ps-marrow", kind: "passage", glyph: "VII", title: "Of the Marrow",
    domain: "body", themes: ["marrow", "bone", "deep", "rearrange"], placeholder: true,
    objectArchetype: "book-on-side",
  ...
  {
    id: "ps-quiet-yes", kind: "passage", glyph: "VIII", title: "The Quiet Yes",
    domain: "voice", themes: ["yes", "refusal", "consent", "small"], placeholder: true,
    objectArchetype: "leather-book",
  ...
  {
    id: "ps-ash-petal", kind: "passage", glyph: "IX", title: "Ash and Petal",
    domain: "spirit", themes: ["ash", "petal", "burn", "remain"], placeholder: true,
    objectArchetype: "open-codex",
  ...
  {
    id: "ps-witness", kind: "passage", glyph: "X", title: "On Witness",
    domain: "service", themes: ["witness", "see", "remedy", "sit"], placeholder: true,
    objectArchetype: "book-on-side",
  ...
  {
    id: "ps-refusal", kind: "passage", glyph: "XI", title: "On the Refusal",
    domain: "relations", themes: ["refusal", "no", "boundary", "discernment"], placeholder: true,
    objectArchetype: "book-on-side",
  ...
  {
    id: "ps-returning", kind: "passage", glyph: "XII", title: "On Returning",
    domain: "spirit", themes: ["return", "again", "change", "measurement"], placeholder: true,
    objectArchetype: "open-codex",
...
// ── Vessels ────────────────────────────────────────────────────────────────
// Archetype mapping is curated by tonal feel — alchemystic resonates with the
// brass bowl's sustained ring, my-word-is-on-fire with the bell's single strike,
// hermetic-seal with the literal sealed vial. Project owner may refine later.
...
const VESSEL_SOURCES: VesselSeed[] = [
  ...
  },
  {
    ...
    objectArchetype: "glass-vial", mistColor: "gold",
    lyrics: [
  ...
  },
  {
    ...
    objectArchetype: "glass-vial", mistColor: "violet",
    lyrics: [
  ...
  },
  {
    ...
    objectArchetype: "glass-vial", mistColor: "blue",
    lyrics: [
...
export const VESSELS: Vessel[] = VESSEL_SOURCES.map((v, i) => ({
  ...
  domain: v.domain,
  placeholder: true,
  objectArchetype: v.objectArchetype,
  mistColor: v.mistColor,
