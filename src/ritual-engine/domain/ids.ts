...
export type CanonicalRouteId = Brand<string, "CanonicalRouteId">;
export type CanonicalQuestionId = Brand<string, "CanonicalQuestionId">;
export type ParticipantAssetKey = Brand<string, "ParticipantAssetKey">;
